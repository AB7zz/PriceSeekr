    ...
    return (
        <>
            <div className="flex flex-col overflow-hidden">
                ...
                <h2 className="text-gray-600 text-[25px] relative w-full text-center">API Limit Exceeded</h2>
                ...
                <div className="relative w-full h-[14rem] mt-2 bg-black rounded-lg text-center">
                    ...
                    <p className="text-white text-md px-4">
                        You've exceeded your API limit. Please try again later.
                    </p>
                </div>
